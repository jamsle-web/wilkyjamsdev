...
window.LEGAL_CONTENT = {
  es:{
    ...
    'help.html':{title:'Centro de ayuda · Jamsle Porcena',desc:'Ayuda para encontrar servicios, proyectos, tienda, contacto y pagos.'}
  },
  en:{
  ...
  fr:{
    ...
    'help.html':{title:"Centre d'aide · Jamsle Porcena",desc:'Aide pour trouver les services, projets, boutique, contact et paiements.'}
  }
};
window.applyLegalLanguage = function(){
 ...
 const legal={
  ...
  cookies:['Política de cookies','Este sitio prioriza tecnologías esenciales para que sus funciones trabajen correctamente.','Almacenamiento local','El carrito y la preferencia de idioma pueden guardarse en el almacenamiento local del navegador. Esto permite conservar el carrito y recordar el idioma entre páginas.','Cookies de terceros','Algunos recursos externos, como fuentes, iconos, servicios de pago o contenido integrado, pueden aplicar sus propias tecnologías según su configuración. El sitio no utiliza estas tecnologías para crear perfiles publicitarios propios.','Preferencias','Puedes borrar el almacenamiento local y las cookies desde la configuración de tu navegador. Algunas funciones, como el carrito o el idioma guardado, podrían reiniciarse.'],
